...
class BooksController
{
    ...
    /**
     * ACTION: addBook
     * This method handles what happens when you move to http://yourproject/songs/addbook
    ...
    public function addBook()
    {
        ...
        if (isset($_POST["submit_add_book"])) {
            ...
            $Book->addBook($_POST["author"], $_POST["title"],  $_POST["link"]);
        }
    ...
    public function editBook($book_id)
    {
        ...
        if (isset($book_id)) {
            ...
            // redirect user to books index page (as we don't have a song_id)
            header('location: ' . URL . 'books/index');
        }
    }
    ...
    public function updateBook()
    {
        ...
        if (isset($_POST["submit_update_book"])) {
            ...
            $Book->updateBook($_POST["author"], $_POST["title"],  $_POST["link"], $_POST['book_id']);
        }
